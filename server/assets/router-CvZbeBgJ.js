...
const appCss = "/dito-feito-landing/assets/styles-BQmGbSPv.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Dito e Feito — Futebol e Resenha · Desde 2010" },
      { name: "description", content: "Dito e Feito: time amador de futebol e resenha desde 2010. Glórias, redenção e a Edição 2026 do nosso uniforme." },
      { property: "og:title", content: "Dito e Feito — Futebol e Resenha" },
      { property: "og:description", content: "Tradição, glórias e o novo manto Edição 2026. Desde 2010." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Anton&family=Manrope:wght@300;400;500;600;700;800&display=swap" }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-FspNWRTa.js");
